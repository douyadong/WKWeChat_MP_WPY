...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------++*/
let pullLoadXfRequestData = {
    "agentId": null,
    "pageIndex": 0,
    "pageSize": 10
};
let pullLoadEsfRequestData = {
    "agentId": null,
    "pageIndex": 0,
    "pageSize": 10
};
...
let params = $.extend(true, {}, detailFoot, {
    ...
    swapToTab: function(event) {
        this.setData({
            "currentSourcesTab": event.currentTarget.dataset.tab
        });
    },
    /*++----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    extendAgentBizTownList: function() {
        this.setData({
            "agentBizTownListExtendable": false
        });
    },
    /*++----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    点经纪人电话，拨打电话
    ...
    extendAgentIntroduction: function() {
        this.setData({
            "agentIntroductionExtendable": false
        });
    },
    /*++----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    展开成交故事的方法
        ...
        request.fetch({
            ...
            success: function(res) {
                ...
                if (res.data && res.data.length) {
                    _.setData({
                        "esfSources": result.concat(_.mapSource(res.data))
                    });
                } else _.setData({
                    "esfIsNoData": true
                });
